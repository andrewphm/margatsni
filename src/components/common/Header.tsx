    ...
    <>
      <header className="sticky top-0 flex min-h-[60px] w-full items-center justify-center border bg-white">
        ...
        <div className=" flex w-full items-center justify-between px-5 md:hidden">
          ...
          <div
            ref={menuRef}
            className="absolute top-[64px] right-[13px] z-10 flex w-56 -translate-y-96  rounded-md bg-white opacity-0 shadow-[0px_0px_5px_1px_rgba(0,0,0,0.0975)] transition-opacity duration-500 ease-linear"
          >
            <ul className="h-full w-full text-sm">
              <li className="flex cursor-pointer items-center gap-x-2 rounded-t-md py-[10px] px-4 hover:bg-gray-100">
                <svg
